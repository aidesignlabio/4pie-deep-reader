...
4. Read [bazi-l1-policy.md](references/bazi-l1-policy.md), then run `scripts/adjudicate_bazi_l1.py`.
...
8. Read [scoring-contract.md](references/scoring-contract.md). Run `scripts/score_domains.py`; never invent scores in the Reader.
