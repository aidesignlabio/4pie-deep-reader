...
def _setup_jhora():
    """Install the shared, idempotent PyJHora compatibility adapter."""
    from pyjhora_compat import install_swisseph_compat
    install_swisseph_compat()
...
def calculate_dasha_fixed(year, month, day, hour, minute, lat, lon, tz_offset):
    ...
    from pyjhora_compat import install_mean_node_policy
    install_mean_node_policy(drik)
